...
public interface ICoordinadorDAO {
    ...
    ArrayList<Coordinador> findCoordinadorWithUsuarioByName(String searchName);

    Coordinador findCoordinadorWithUsuarioById(int idCoordinador);

    Coordinador getCoordinadorWithUsuario(ResultSet resultSet);
