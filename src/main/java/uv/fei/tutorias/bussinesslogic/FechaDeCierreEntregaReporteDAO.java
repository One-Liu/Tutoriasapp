...
public class FechaDeCierreEntregaReporteDAO implements IFechaDeCierreEntregaReporteDAO {
    ...
    private final Logger LOGGER = Logger.getLogger(FechaDeCierreEntregaReporteDAO.class);
    
    @Override
    public ArrayList<FechaDeCierreEntregaReporte> findFechasDeCierreEntregaReporteByFecha(String searchDate) {
        ArrayList<FechaDeCierreEntregaReporte> fechasDeCierreEntregaReporte = new ArrayList<>();
    ...
    public FechaDeCierreEntregaReporte getFechaDeCierreEntregaReporte(ResultSet resultSet) {
        ...
        FechaDeCierreEntregaReporte fechaDeCierreEntregaReporte = new FechaDeCierreEntregaReporte(idFechaDeCierreEntregaReporte,fechaDeCierre,idReporteDeTutoriaAcademica);
        return fechaDeCierreEntregaReporte;
    }
    ...
    public boolean addFechaDeCierreEntregaReporte(FechaDeCierreEntregaReporte fechaDeCierreEntregaReporte) {
        ...
        try(Connection connection = dataBaseConnection.getConnection()) {
            ...
            statement.setInt(2, fechaDeCierreEntregaReporte.getIdReporteDeTutoriaAcademica());
